/* ====================================================
   ...
   Adapted from React Three Fiber to vanilla Three.js
   ==================================================== */
...
(function () {
  ...
  container.className = 'hero__shader';
  container.setAttribute('aria-hidden', 'true');
  hero.insertBefore(container, hero.firstChild);
  hero.classList.add('hero--has-shader');
  ...
  // ─── INTRO ANIMATION ─────────────────────────────
  // Start with blur + scale, animate in
  container.style.filter = 'blur(20px)';
  container.style.transform = 'scale(1.1)';
  container.style.opacity = '0.7';

  requestAnimationFrame(() => {
    container.style.transition = 'filter 1.5s cubic-bezier(0.16, 1, 0.3, 1), transform 1.5s cubic-bezier(0.16, 1, 0.3, 1), opacity 1.5s cubic-bezier(0.16, 1, 0.3, 1)';
    setTimeout(() => {
  ...
  // ─── VISIBILITY: only render when hero is in view ─
